        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-semibold">
              ...
              <li>
                <Link to="/projects" className="text-slate-500 hover:text-indigo-600 transition-colors">Explore</Link>
              </li>
              <li>
                <Link to="/publish" className="text-slate-500 hover:text-indigo-600 transition-colors">Publish</Link>
              </li>
            </ul>
          </div>
